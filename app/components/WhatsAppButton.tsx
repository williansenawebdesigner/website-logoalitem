...
export default function WhatsAppButton({ phoneNumber, message }: WhatsAppButtonProps) {
  ...
  const handleClick = () => {
    if (typeof window !== "undefined" && typeof window.gtag === "function") {
      console.log("✅ Enviando evento de conversão para o Google Ads...");

      window.gtag("event", "conversion", {
        send_to: "AW-16866351206/7q4UCP-8pJ0aEOawwOo-",
        value: 1.0,
        currency: "BRL",
      });

      console.log("✅ Evento de conversão enviado com sucesso!");
    } else {
      console.warn("⚠️ window.gtag não está disponível.");
    }
